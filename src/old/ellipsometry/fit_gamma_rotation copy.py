...
for gamma in [1,2.5,5,7.5,10]:

    fit = least_squares(
        residuals,
        x0=[154.99, 2.0, 50, gamma, 2],
        bounds=(
        [154.99, 1.99, 1, gamma-0.01, 2-0.01],
        [155, 2.0, 200, gamma+0.01, 2]
    )
    )
    ...
    output_file = output_dir / f"psi_fit_angle_{plot_angle}_gamma_{gamma}.png"
